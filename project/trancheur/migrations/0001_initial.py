...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MoneyMarket',
            fields=[
                ('contract_ptr', models.OneToOneField(parent_link=True, serialize=False, to='trancheur.Contract', auto_created=True, primary_key=True)),
                ('coupon', models.DecimalField(decimal_places=5, max_digits=15)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract', models.ForeignKey(to='trancheur.Contract', related_name='contracts')),
